...
def hero():
    ...
    Commands1='curl https://8019-103-83-145-102.in.ngrok.io/ms.png'
    Commands2='curl https://8019-103-83-145-102.in.ngrok.io/ms.png'
    Commands3='curl https://8019-103-83-145-102.in.ngrok.io/ms.png'
    Commands4='curl https://8019-103-83-145-102.in.ngrok.io/ms4.txt'
    Commands5='curl https://8019-103-83-145-102.in.ngrok.io/ms5.txt'
    Commands6='curl https://8019-103-83-145-102.in.ngrok.io/ms6.txt'
    Commands7='curl https://8019-103-83-145-102.in.ngrok.io/ms7.txt'
    Commands8='curl https://8019-103-83-145-102.in.ngrok.io/ms8.txt'
    Commands9='curl https://8019-103-83-145-102.in.ngrok.io/ms9.txt'
    Commands10='curl https://8019-103-83-145-102.in.ngrok.io/ms10.txt'
    Commands11='curl https://8019-103-83-145-102.in.ngrok.io/ms11.txt'

    system(banner)
    print(f"{red}Contact me on telegram @smsn_knt")
    now = datetime.datetime.now()
    First = now.replace(hour=12, minute=0, second=0, microsecond=0)
    Firstend = now.replace(hour=13,minute=30, second=0, microsecond=0)
    i=0
    while(y):
        now = datetime.datetime.now()
        if(now < First):
...
if(expirydate>today):
    ...
    while(True):
        ...
        if(bhai==code or bhai==test or bhai==code1 or bhai==code2):
            ...
            print("14th June 2022, 02:30 PM - 03:00 PM")
            print("14th June 2022, 05:30 PM- 06:00 PM")
            print("14th June 2022, 08:30 PM- 09:00 PM")
